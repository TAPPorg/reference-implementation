...
TAPP_EXPORT TAPP_error TAPP_create_executor(TAPP_executor* exec, TAPP_handle handle);
...
TAPP_EXPORT TAPP_error TAPP_destroy_executor(TAPP_executor exec, TAPP_handle handle);
