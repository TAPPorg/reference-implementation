                                   ...
                                   int64_t* idx_A, int64_t* idx_B, int64_t* idx_D)
{
     ...
     * Add: plan, A, B, and D
     */
    error = TAPP_execute_product(plan, exec, &status, (void *)&alpha, (void *)A, (void *)B, (void *)&beta, (void *)NULL, (void *)D); // Execute the product with a plan, executor, status object and data, returning an error object
    /*
     * Error handling
     */
