...
"""
from tapp_einsum import tapp_einsum
import itertools
import operator
    ...
    for num, contraction in enumerate(contraction_list):
        ...
        # Call einsum
            ...
            if handle_out:
                kwargs["out"] = out
            # Do the contraction
            if not (out is None or out.dtype == 'float32' or out.dtype == 'float64' or out.dtype == 'float16' or out.dtype == 'complex128' or out.dtype == 'complex64') and \
                    (tmp_operands[0].dtype == 'float32' or tmp_operands[0].dtype == 'float64' or tmp_operands[0].dtype == 'float16' or tmp_operands[0].dtype == 'complex128' or tmp_operands[0].dtype == 'complex64') and \
                    (tmp_operands[1].dtype == 'float32' or tmp_operands[1].dtype == 'float64' or tmp_operands[1].dtype == 'float16' or tmp_operands[1].dtype == 'complex128' or tmp_operands[1].dtype == 'complex64') and \
                    len(tmp_operands) == 2 and \
                    ("dtype" not in kwargs or ("dtype" in kwargs and (kwargs["dtype"] is None or kwargs["dtype"].__name__ == 'float' or kwargs["dtype"].__name__ == 'float32' or kwargs["dtype"].__name__ == 'float64' or kwargs["dtype"].__name__ == 'float16' or kwargs["dtype"].__name__ == 'complex128' or kwargs["dtype"].__name__ == 'complex64'))): # Contractions should be broken down more instead of capping TAPP
                print("TAPP")
                new_view = tapp_einsum(einsum_str, *tmp_operands, **kwargs)
            else:
                print("numpy")
