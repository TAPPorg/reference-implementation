...
bool test_hadamard_product() {
    ...
    TAPP_execute_product(handle, 0, &status, &alpha, op_A, info_A, A, idx_A, op_B, info_B, B, idx_B, &beta, op_C, info_C, C, idx_C, op_D, info_D, D, idx_D, TAPP_DEFAULT_PREC);
...
bool test_contraction() {
    ...
    TAPP_execute_product(handle, 0, &status, &alpha, 0, info_A, A, idx_A, 0, info_B, B, idx_B, &beta, 0, info_C, C, idx_C, 0, info_D, D, idx_D, TAPP_DEFAULT_PREC);
...
bool test_commutativity() {
    ...
    TAPP_execute_product(handle, 0, &status, &alpha, 0, info_B, B, idx_B, 0, info_A, A, idx_A, &beta, 0, info_C, C, idx_C, 0, info_D, F, idx_D, TAPP_DEFAULT_PREC);
